...
public class Depositar extends Conectar {
    
    public boolean updateD(NuevoDeposito deposito){
        ...
        try{
            String sql = "INSERT INTO movimientos_cuenta_cliente (numero_cliente, tipo_movimiento, monto_movimiento) VALUES(?,'deposito',?)";
