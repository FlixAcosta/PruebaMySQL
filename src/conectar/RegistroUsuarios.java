...
public class RegistroUsuarios extends javax.swing.JFrame {
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        cuenta.setNumero_cliente(Integer.parseInt(jTextField1.getText()));
        cuenta.setNombre_cliente(jTextField2.getText());
        cuenta.setSaldo_cliente(Float.parseFloat(jTextField3.getText()));
        
        if(insert.insertarD(cuenta)){
